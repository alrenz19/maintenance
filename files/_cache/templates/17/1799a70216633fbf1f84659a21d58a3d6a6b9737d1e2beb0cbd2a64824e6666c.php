...
class __TwigTemplate_a7b8700df64490d5b6d20ee7231d7a9de0dbb53fb48d6eaba8d42af018004115 extends Template
{
    private $source;
    private $macros = [];
...
($context["flags_html"] ?? null), _n("Port", "Ports", Session::getPluralNumber())], 60, $context, $this->getSourceContext());
    ...
    {
        return new Source("", "pages/assets/phone.html.twig", "/volume1/web/glpi/templates/pages/assets/phone.html.twig");
    }
}
